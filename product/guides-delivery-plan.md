...
В native dependencies #413 дополнительно ждёт артефакты #450, поскольку проверяет их доступ.
Запуск #414 ждёт полную приёмку #458. Последовательность #450 → #413 → #458 → #414
не позволяет открыть продажи после одной платёжной DEMO без готового руководства.
