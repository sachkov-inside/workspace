...
<!--
Сверка влияния из раздела `Documentation impact` в WORKFLOW.md: какие устойчивые факты изменились и в каком документе-владельце обновлён каждый. Если прозаический документ не нужен, напиши «None — code/schema/tests are the authority».
Источник каждого нового или изменённого правила для агентов или кода: спецификация, ADR, решение владельца или факт о среде, подтверждённый проверкой. Правило без источника перенеси в «Решения владельца».
Уроки сессии из раздела `Session learning`: что перенесено и куда, или «Нет».
-->
